...
const DEFAULT_PROMPT = "Summarise the following article in 3 crisp bullet points:";
var LoginType;
(function (LoginType) {
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.type === 'ANALYTICS') {
        Promise.all([getCachedUserId(), getCachedLoginType()])
            .then(([userId, loginType]) => logEvent(message.data.event_name, userId, loginType));
    }
